...
export const events: UAPEvent[] = [
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/FLIR1_Official_UAP_Footage_from_the_USG_for_Public_Release.webm/1280px--FLIR1_Official_UAP_Footage_from_the_USG_for_Public_Release.webm.jpg', caption: 'FLIR1官方静帧——2004年尼米兹 Tic Tac（USG public release / Wikimedia）' },
...
limitations: ['物体从未被拦截或回收', '物理性质仍为未解之谜'],
  ...
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Gimbal_The_First_Official_UAP_Footage_from_the_USG_for_Public_Release.webm/250px--Gimbal_The_First_Official_UAP_Footage_from_the_USG_for_Public_Release.webm.jpg', caption: 'Gimbal官方静帧——2015年罗斯福号东海岸（USG public release / Wikimedia）' },
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Go_Fast_Official_USG_Footage_of_UAP_for_Public_Release.webm/250px--Go_Fast_Official_USG_Footage_of_UAP_for_Public_Release.webm.jpg', caption: 'GoFast官方静帧——海上高速UAP（USG public release / Wikimedia）' },
...
limitations: ['物理样本未被保存于可靠证据链中', '部分平民报告可能受社会心理因素影响'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://uapglobe.com/img/cases/jal-1628.jpg', caption: '寺内机长手绘的UFO目击图（FAA档案转载）——母舰与两架小飞行器排列' },
...
limitations: ['FAA未公开完整调查报告', '无其他航班同时目击', '可能是视觉误判距离/大小'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/a/a8/EaMalmstrom.jpg', caption: 'Malmstrom Air Force Base（蒙大拿）——1967年 Oscar Flight ICBM 失效事件发生地（公有领域）' },
...
limitations: ['因果关系未被证明', '可能是时间巧合或电磁效应导致'],
  },
  {
    ...
    media: [
      ...
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/8/8c/Vaguebelge%28reconstitution%29.png', caption: '比利时三角飞行器目击者重建图（Wikimedia Commons）' },
...
limitations: ['民航雷达未探测到该物体', '专家组提出多种假说但无法完全解释全部观测要素'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'http://www.uux.cn/attachments/2013/07/1_201307241217161J9z1.jpg', caption: '都溪林场空中怪车事件现场：被拦腰折断的松树桩（神秘的地球 / uux.cn 专题配图）' },
...
limitations: ['无军方传感器记录', '无金属残骸或物理样本回收', '下击暴流假说无法解释全部异常'],
  },
  {
    ...
    media: [
      { type: 'video', url: 'https://www.bilibili.com/video/BV125411T77U/', caption: 'Bilibili视频：1991年上海虹桥机场UFO事件录音公开（卡兰巴扎上传），包含飞行员与虹桥塔台约26分钟通话录音' },
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/2/27/Airport_Shanghai-Hongqiao_1.jpg', caption: '上海虹桥国际机场（事件发生地；无稳定公开的UAP本体照片）' }
    ],
limitations: ['雷达未公开确认锁定该物体', '海军战士录像画质有限', '可能为远距离光源'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Kofu_montage.jpg/960px-Kofu_montage.jpg', caption: '甲府市风貌拼图（事件发生地山梨县甲府；公开着陆痕迹照片链路不稳定）' },
...
limitations: ['未公开视频、照片或详细传感器数据', '核潜艇传感器数据通常不对外公开'],
  },
  {
    ...
    media: [
      ...
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Salyut_6_drawing.svg/500px-Salyut_6_drawing.svg.png', caption: '礼炮6号空间站结构图（Wikimedia Commons）' }
    ],
limitations: ['无照片或录像记录', '可能是太空碎片或卫星解体事件'],
  },
  {
    ...
    media: [
      ...
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Salyut-7kosmos1686mayakT-15.jpg/500px-Salyut-7kosmos1686mayakT-15.jpg', caption: '礼炮7号空间站（苏联/俄罗斯公有领域）' },
...
limitations: ['无照片、视频、雷达或任何仪器记录', '可能是疲劳、缺氧或宇宙射线引发的视觉现象'],
  },
  {
    ...
    media: [
      ...
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Apollo_17_The_Last_Moon_Shot_Edit1.jpg/960px-Apollo_17_The_Last_Moon_Shot_Edit1.jpg', caption: '阿波罗17号发射（NASA / Wikimedia Commons）' },
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Blue_marble_apollo_17_19721207_%28cropped%29.png/500px-Blue_marble_apollo_17_19721207_%28cropped%29.png', caption: '阿波罗17号蓝色弹珠地球照片（NASA）' }
    ],
...
limitations: ['McDivitt是唯一直接目击者（White在睡觉）', 'NORAD提出可能是Pegasus B卫星但角尺寸不符'],
  },
  {
    ...
    media: [
      ...
      { type: 'video', url: 'http://terrygroff.com/dfwmufon/audio/halt%20tape.mp3', caption: 'Charles Halt中校现场录音 Halt Tape（MP3）：1980年12月28日约18分钟原始录音' }
    ],
...
limitations: ['部分目标可能是温度逆转造成的雷达异常', '缺乏照片或物理证据'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/8/8c/Tether_Still.jpg', caption: 'STS-75 / TSS-1R 导电系绳部署静帧（Wikimedia Commons / NASA 相关任务影像）' },
...
limitations: ['物体可能是系绳附近的碎片或冰晶', '距离和尺寸难以判断'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://images.huffingtonpost.com/2012-03-13-Screenshot20120313at4.11.53PM.png', caption: 'CEFAA El Bosque 航展分析静帧（HuffPost / Leslie Kean 报道配图）' },
      { type: 'image', url: 'https://images.huffingtonpost.com/2012-03-13-Screenshot20120313at4.10.26PM.png', caption: 'El Bosque 2010 多角度录像分析放大帧（HuffPost 报道）' },
...
limitations: ['部分技术细节未公开', '可能是已知飞行物或自然现象'],
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://cdn.eso.org/images/screen/eso1737b.jpg', caption: '实际望远镜深空合成图像：ʻOumuamua位于中心，周围为星轨。Credit: ESO/K. Meech et al.' },
      { type: 'image', url: 'https://esahubble.org/media/archives/images/large/heic1813a.jpg', caption: 'ESA/Hubble 艺术家印象（媒体画廊保留；时间线封面使用真实望远镜图）。Credit: ESA/Hubble, NASA, ESO, M. Kornmesser' },
      { type: 'image', url: 'https://apod.nasa.gov/apod/image/1711/OumuamuaDrawing_ESO_960.jpg', caption: 'NASA APOD：ʻOumuamua穿越太阳系示意图。Credit: NASA, JPL, Caltech' },
      { type: 'video', url: 'https://www.jpl.nasa.gov/videos/first-interstellar-asteroid-wows-scientists/', caption: 'NASA JPL官方视频：首个星际小行星令科学家惊叹（2017）' },
      { type: 'video', url: 'https://esahubble.org/videos/heic1813a/', caption: 'ESA/Hubble Hubblecast 111：ʻOumuamua获得意外加速' }
    ],
limitations: ['星际物体与近地UAP是两个独立现象', '异常特征可被自然物理解释'],
...

  {
    ...
    media: [
      { type: 'image', url: 'https://nuforc.org/wp-content/uploads/2025/04/S183084_2.jpg', caption: 'NUFORC Troy21 case graphic for the Sept 17, 2024 DHS Beechcraft near-miss (no public UAP body photograph)' },
      { type: 'video', url: 'https://www.newsnationnow.com/banfield/us-military-pilots-encounter-with-ufo-this-is-going-to-sound-weird/', caption: 'NewsNation Banfield report featuring leaked ATC audio of DHS pilot Troy 21 describing a football-sized object under his wing on Sept 17, 2024' },
      { type: 'video', url: 'https://nuforc.org/troy21/', caption: 'NUFORC Troy21 investigation page with FOIA ATC audio and case write-up' }
    ],
...

  {
    ...
    media: [
      { type: 'image', url: 'https://cdn.abcotvs.com/dip/images/15546386_pentagon-file-img.jpg', caption: 'ABC7：AARO FY2024 年报相关报道配图（覆盖纽约商业航班圆柱体近撞记录的公开语境）' },
      { type: 'image', url: 'https://cdn.abcotvs.com/dip/images/15544790_111424-wpvi-n1-ufo-hearing-pkg-video-vid.jpg', caption: 'ABC7：与 AARO/UAP 年报听证会相关的新闻画面' },
      { type: 'video', url: 'https://www.youtube.com/watch?v=DP7Nwb-z1_o', caption: 'AARO FY2024年度报告媒体圆桌会议相关视频 — 2024年11月14日，AARO主任Jon Kosloski讨论年度报告中的757份UAP报告。' }
    ],
...

  {
    ...
    sensors: ["目视"],
    physicalCharacteristics: ["metallic", "cylindrical", "commercial-airplane-size", "stationary-hover", "bright-white-light", "sudden-disappearance"],
    sources: [
...

  {
    ...
    media: [
      ...
      { type: 'video', url: 'https://www.dvidshub.net/video/1006073/dow-uap-pr28-unresolved-uap-report-greece-january-2024', caption: 'Official DVIDS page for DOW-UAP-PR28: unresolved UAP report submitted by USCENTCOM to AARO.' }
    ],
...

  {
    ...
    media: [
      ...
      { type: 'video', url: 'https://www.dvidshub.net/video/962722/unresolved-uap-report-middle-east-2024', caption: 'DVIDS/AARO官方视频：2024年中东地区红外传感器未解决UAP报告（与D75同区域作战语境，非Hellfire专属画面）' }
    ],
...

  {
    ...
    media: [
      { type: 'image', url: 'https://uaplogbook.com/content/images/size/w1200/2026/07/pursue-release-04/nasa-uap-d030-sts-80.jpg', caption: 'NASA-UAP-D030：STS-80 低地球轨道不明物原图（PURSUE Release 04 / UAP Logbook）' },
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/4/4a/STS-80_Roll_Out_01.jpg', caption: 'STS-80 任务：航天飞机哥伦比亚号运抵 39B 发射台（1996年10月16日，NASA / 公有领域）' },
    ],
...

  {
    ...
    relatedEvents: ['east-china-sea-uap-2025'],
    media: [
      { type: 'image', url: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014101/DOD_111830027.0000001/1000w_q95.jpg', caption: 'DVIDS 静帧：DOW-UAP-PR104 黄海六角星状红外对比区域（INDOPACOM/AARO）' },
...

  {
    ...
    relatedEvents: ['yellow-sea-six-pointed-star-2025'],
    media: [
      { type: 'image', url: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014103/DOD_111830030.0000001/1000w_q95.jpg', caption: 'DVIDS 静帧：DOW-UAP-PR105 东海红外跟踪对比区域（INDOPACOM/AARO）' },
...

  {
    ...
    media: [
      { type: 'image', url: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014128/DOD_111830201.0000001/1000w_q95.jpg', caption: 'DVIDS 静帧：DOW-UAP-PR112 2019年美东矩形高速UAP（U.S. Navy/AARO）' },
