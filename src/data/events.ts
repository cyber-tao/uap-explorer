...
export const events: UAPEvent[] = [
  {
    ...
    relatedEvents: ['gimbal-gofast', 'submarine-transmedium', 'uss-jackson-tictac-2023'],
  },
  {
    id: 'gimbal-gofast',
    date: '2014-2015',
  ...
  },
  {
    ...
    relatedEvents: ['nimitz-tic-tac', 'uss-jackson-tictac-2023', 'gimbal-gofast'],
  },
  {
    id: 'salyut6',
    date: '1981-05',
...

  {
    ...
    relatedEvents: ['uae-inverted-teardrop-2024', 'syria-white-light-orb-2024'],
...

  {
    ...
    relatedEvents: ['tremonton-great-falls-1952', 'washington-invasion', 'roswell'],
...

  {
    ...
    relatedEvents: ['east-china-sea-uap-2025', 'indopacom-ir-uap-2024', 'dhs-pilot-football-object-2024'],
...

  {
    ...
    relatedEvents: ['yellow-sea-six-pointed-star-2025', 'indopacom-ir-uap-2024', 'dhs-pilot-football-object-2024'],
...

  {
    ...
    figures: [
      { src: '/images/events/uae-inverted-teardrop-2024/01.jpg', caption: 'DVIDS DOW-UAP-PR29 红外静帧：阿联酋上空倒泪滴形对比区域（含底部垂直附体形态）', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006074/DOD_111688964.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/uae-inverted-teardrop-2024/02.png', caption: '阿联酋区位示意——PR29 目击相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/United_Arab_Emirates_%28orthographic_projection%29.svg/1280px-United_Arab_Emirates_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/uae-inverted-teardrop-2024/03.jpg', caption: '阿尔达夫拉空军基地相关活动影像——事件地理语境参考（非UAP本体）', credit: 'U.S. Air National Guard / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Al_Dhafra_Air_Base_gathers_humanitarian_relief_supplies_for_Afghanistan_refugees_210820-Z-BR512-2017.jpg/1280px-Al_Dhafra_Air_Base_gathers_humanitarian_relief_supplies_for_Afghanistan_refugees_210820-Z-BR512-2017.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111688964/DOD_111688964.mp4', caption: 'DoD 直链视频（21秒）：DOW-UAP-PR29 阿联酋红外 footage，倒泪滴形对比区域' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006074/dow-uap-pr29-unresolved-uap-report-united-arab-emirates-june-2024', caption: '官方 DVIDS：DOW-UAP-PR29 未解决UAP报告（United Arab Emirates, June 2024）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['inverted-teardrop', 'vertical-appendage', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR29 UAE June 2024', url: 'https://www.dvidshub.net/video/1006074/dow-uap-pr29-unresolved-uap-report-united-arab-emirates-june-2024' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['greece-diamond-uap-2024', 'syria-white-light-orb-2024', 'uae-ir-track-2023'],
    limitations: ['观察者本人怀疑可能是水面反射，非物理空中物体', '仅单一红外传感器，无雷达或目视交叉验证', '未提供平台高度、速度或具体坐标', '视频仅21秒，缺乏上下文'],
  },

  {
    ...
    figures: [
      { src: '/images/events/syria-white-light-orb-2024/01.jpg', caption: 'DVIDS DOW-UAP-PR32 FMV 静帧：叙利亚上空不规则白色光球/对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006078/DOD_111688997.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/syria-white-light-orb-2024/02.png', caption: '叙利亚区位示意——PR32 目击相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Syria_%28orthographic_projection%29.svg/1280px-Syria_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/syria-white-light-orb-2024/03.png', caption: '叙利亚在全球方位示意——CENTCOM 作战区地理语境', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Syria_on_the_globe_%28Afro-Eurasia_centered%29.svg/1280px-Syria_on_the_globe_%28Afro-Eurasia_centered%29.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111688997/DOD_111688997.mp4', caption: 'DoD 直链视频（6秒）：DOW-UAP-PR32 叙利亚 FMV footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006078/dow-uap-pr32-unresolved-uap-report-syria-october-2024', caption: '官方 DVIDS：DOW-UAP-PR32 未解决UAP报告（Syria, October 2024）' },
    ],
    sensors: ['FMV(全动态视频)'],
    physicalCharacteristics: ['orb', 'bright-white-light', 'glare-halo', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR32 Syria Oct 2024', url: 'https://www.dvidshub.net/video/1006078/dow-uap-pr32-unresolved-uap-report-syria-october-2024' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['uae-inverted-teardrop-2024', 'greece-diamond-uap-2024', 'gulf-of-aden-uap-2024'],
    limitations: ['仅6秒视频，极短', '画面出现眩光/光晕效应，可能是镜头光学伪影', '未提供平台类型、高度、速度等参数', '未报告雷达或目视确认'],
  },

  {
    ...
    figures: [
      { src: '/images/events/uss-jackson-tictac-2023/01.jpg', caption: 'USS Jackson（LCS-6）在航——2023年 Tic Tac 跨介质遭遇相关载具', credit: 'U.S. Navy / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/USS_Jackson_%28LCS-6%29_underway_in_the_Philippine_Sea_on_18_October_2021_%28211018-N-PL200-0005%29.JPG/1280px-USS_Jackson_%28LCS-6%29_underway_in_the_Philippine_Sea_on_18_October_2021_%28211018-N-PL200-0005%29.JPG', layout: 'full' },
      { src: '/images/events/uss-jackson-tictac-2023/02.jpg', caption: 'USS Jackson 靠泊影像——Independence 级濒海战斗舰平台参考', credit: 'U.S. Navy / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/USS_Jackson_LCS-6_13_May_2024_NBSD.jpg/1280px-USS_Jackson_LCS-6_13_May_2024_NBSD.jpg', layout: 'pair' },
      { src: '/images/events/uss-jackson-tictac-2023/03.jpg', caption: 'USS Jackson 抵港画面——舰体与上层建筑细节', credit: 'U.S. Navy / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/USS_Jackson_arrives_in_Portland_for_Rose_Festival_Fleet_Week._%2834388102593%29_%28cropped%29.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://defensescoop.com/2025/09/09/military-whistleblowers-share-new-evidence-alleged-uap-ufo-hearing/', caption: 'DefenseScoop：2025年9月9日众议院UAP听证会——含Wiggins证词与新证据报道' },
      { type: 'video', url: 'https://www.rev.com/transcripts/house-uap-whistleblower-hearing', caption: 'Rev.com：众议院UAP举报人听证会文字记录（含USS Jackson遭遇陈述）' },
    ],
    sensors: ['雷达', 'Sapphire图像系统', '目视'],
    physicalCharacteristics: ['transmedium', 'instantaneous-acceleration', 'multi-sensor', 'self-luminous', 'group-sighting'],
    sources: [
      { label: 'DefenseScoop - Wiggins testimony Sep 2025', url: 'https://defensescoop.com/2025/09/09/military-whistleblowers-share-new-evidence-alleged-uap-ufo-hearing/' },
      { label: 'Rev.com - House UAP Hearing Transcript', url: 'https://www.rev.com/transcripts/house-uap-whistleblower-hearing' },
      { label: 'Popular Mechanics - Navy Officer Underwater UFOs', url: 'https://www.popularmechanics.com/military/a65709166/navy-officer-says-underwater-ufos-are-legitimate-threats-the-evidence-is-hard-to-ignore/' },
    ],
    relatedEvents: ['nimitz-tic-tac', 'submarine-transmedium', 'gimbal-gofast'],
    limitations: ['2023年事件于2025年才公开作证', '完整原始传感器数据包尚未由DoD正式发布', 'AARO尚未就该个案发布独立结案结论'],
  },

  {
    ...
    figures: [
      { src: '/images/events/langley-afb-drone-swarm-2023/01.jpg', caption: 'F-22 飞越兰利-尤斯蒂斯联合基地——2023年12月无人机群入侵相关基地', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/2_U.S._Air_Force_F-22_Raptors_fly_over_Joint_Base_Langley-Eustis%2C_Virginia%2C_June_12%2C_2018.jpg/1280px-2_U.S._Air_Force_F-22_Raptors_fly_over_Joint_Base_Langley-Eustis%2C_Virginia%2C_June_12%2C_2018.jpg', layout: 'full' },
      { src: '/images/events/langley-afb-drone-swarm-2023/02.jpg', caption: '兰利空军基地停机坪上的 F-22——事件期间战斗机训练与转场受影响', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/F-22_Raptors_at_Langley_-_050608-F-2295B-049.jpg/1280px-F-22_Raptors_at_Langley_-_050608-F-2295B-049.jpg', layout: 'pair' },
      { src: '/images/events/langley-afb-drone-swarm-2023/03.jpg', caption: '兰利空军基地历史设施影像——基地空域安全语境参考', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/bc/WS_430B_at_Langley_Air_Force_Base.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://globalnews.ca/news/10812987/mysterious-drones-langley-air-force-base/', caption: 'Global News：兰利空军基地神秘无人机群入侵报道' },
      { type: 'video', url: 'https://defensescoop.com/2024/11/14/uap-aaro-chief-unveils-pentagon-annual-caseload-analysis-new-efforts/', caption: 'DefenseScoop：AARO 年度案件分析简报中提及兰利等敏感设施入侵语境' },
    ],
    sensors: ['目视', '雷达'],
    physicalCharacteristics: ['swarm-behavior', 'repeated-sighting', 'group-sighting', 'flight-safety-hazard', 'low-observability'],
    sources: [
      { label: 'Global News - Mystery drones swarm Langley AFB', url: 'https://globalnews.ca/news/10812987/mysterious-drones-langley-air-force-base/' },
      { label: 'DefenseScoop - AARO briefing mentions Langley', url: 'https://defensescoop.com/2024/11/14/uap-aaro-chief-unveils-pentagon-annual-caseload-analysis-new-efforts/' },
      { label: 'Newsweek - Drones over Langley', url: 'https://www.newsweek.com/drones-langley-air-force-base-us-military-mystery-1968605' },
    ],
    relatedEvents: ['eglin-afb-silver-orbs-2024', 'pantex-intrusion-2015', 'gov-contractor-metallic-cylinder-2024'],
    limitations: ['物体身份未公开确认（可能为外国/商业/爱好者无人机）', '未击落、未回收实物', '完整传感器与交战决策记录大多未解密'],
  },

  {
    ...
    figures: [
      { src: '/images/events/indopacom-ir-uap-2024/01.jpg', caption: 'DVIDS DOW-UAP-PR48 红外静帧：印太战区未解决UAP对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006110/DOD_111689167.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/indopacom-ir-uap-2024/02.png', caption: '太平洋区位示意——INDOPACOM 责任区地理背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Pacific_Ocean_-_en.png', layout: 'pair' },
      { src: '/images/events/indopacom-ir-uap-2024/03.jpg', caption: '印太区域轮廓示意（含东盟叠加）——PR48 作战区语境', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg/1280px-Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689167/DOD_111689167.mp4', caption: 'DoD 直链视频（1分39秒）：DOW-UAP-PR48 印太红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006110/dow-uap-pr48-unresolved-uap-report-indopacom-2024', caption: '官方 DVIDS：DOW-UAP-PR48 未解决UAP报告（INDOPACOM 2024）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'low-observability', 'multi-sensor'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR48 INDOPACOM 2024', url: 'https://www.dvidshub.net/video/1006110/dow-uap-pr48-unresolved-uap-report-indopacom-2024' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['yellow-sea-six-pointed-star-2025', 'east-china-sea-uap-2025'],
    limitations: ['报告者无口头/书面描述', '仅红外传感器公开', '对比区域可能对应多种热源，缺乏识别结论'],
  },

  {
    ...
    figures: [
      { src: '/images/events/africa-uap-2025/01.jpg', caption: 'DVIDS DOW-UAP-PR43 红外静帧：非洲战区短暂对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006159/DOD_111689759.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/africa-uap-2025/02.png', caption: '非洲大陆区位示意——AFRICOM PR43 相关地理背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Africa_%28orthographic_projection%29.svg/1280px-Africa_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/africa-uap-2025/03.png', caption: '非洲政区轮廓示意——精确事发点未公开', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Africa_location_map_without_rivers.svg/1280px-Africa_location_map_without_rivers.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689759/DOD_111689759.mp4', caption: 'DoD 直链视频（2秒循环）：DOW-UAP-PR43 非洲红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006159/dow-uap-pr43-unresolved-uap-report-africa-2025', caption: '官方 DVIDS：DOW-UAP-PR43 未解决UAP报告（Africa 2025）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'high-speed', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR43 Africa 2025', url: 'https://www.dvidshub.net/video/1006159/dow-uap-pr43-unresolved-uap-report-africa-2025' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['indopacom-ir-uap-2024', 'gulf-of-aden-uap-2024'],
    limitations: ['仅2秒视频，极短且难以分析运动学', '报告者无任何口头或书面描述', '目标几乎无法区分，可能为鸟类、小型无人机或传感器噪声', '循环播放可能造成连续运动错觉'],
  },

  {
    ...
    figures: [
      { src: '/images/events/greece-ocean-90deg-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR34 红外静帧：希腊近海对比区域（含跟踪十字线时段画面）', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006080/DOD_111689011.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/greece-ocean-90deg-2023/02.png', caption: '希腊区位示意——PR34 / CENTCOM 希腊近海目击相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/EU-Greece_%28orthographic_projection%29.svg/1280px-EU-Greece_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/greece-ocean-90deg-2023/03.png', caption: '地中海区位示意——近海低空飞行语境参考', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Mediterranean_Sea_location_map.svg/1280px-Mediterranean_Sea_location_map.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689011/DOD_111689011.mp4', caption: 'DoD 直链视频（2分57秒）：DOW-UAP-PR34 希腊近海红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006080/dow-uap-pr34-unresolved-uap-report-greece-october-2023', caption: '官方 DVIDS：DOW-UAP-PR34 未解决UAP报告（Greece, October 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['ninety-degree-turns', 'thermal-contrast', 'low-observability', 'transmedium-suspected'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR34 Greece Oct 2023', url: 'https://www.dvidshub.net/video/1006080/dow-uap-pr34-unresolved-uap-report-greece-october-2023' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['greece-diamond-uap-2024', 'greece-circular-ocean-2023', 'uae-inverted-teardrop-2024', 'gulf-of-aden-uap-2024'],
    limitations: ['约80 mph 的直角转弯描述来自任务报告，公开视频难以独立复核动力学', '后期对比区域与背景不可区分，存在传感器/背景混淆可能', '未公开精确坐标、平台型号与距离', 'unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/indopacom-football-radial-2024/01.jpg', caption: 'DVIDS DOW-UAP-PR46 红外静帧：足球形主体与径向突起对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006106/DOD_111689133.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/indopacom-football-radial-2024/02.png', caption: '太平洋区位示意——INDOPACOM 责任区地理背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Pacific_Ocean_-_en.png', layout: 'pair' },
      { src: '/images/events/indopacom-football-radial-2024/03.jpg', caption: '印太区域轮廓示意（含东盟叠加）——PR46 作战区语境', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg/1280px-Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689133/DOD_111689133.mp4', caption: 'DoD 直链视频（9秒）：DOW-UAP-PR46 印太红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006106/dow-uap-pr46-unresolved-uap-report-indopacom-2024', caption: '官方 DVIDS：DOW-UAP-PR46 未解决UAP报告（INDOPACOM 2024）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['football-sized', 'radial-projections', 'thermal-contrast', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR46 INDOPACOM 2024', url: 'https://www.dvidshub.net/video/1006106/dow-uap-pr46-unresolved-uap-report-indopacom-2024' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['indopacom-ir-uap-2024', 'yellow-sea-six-pointed-star-2025', 'dhs-pilot-football-object-2024'],
    limitations: ['仅9秒视频，缺乏运动学上下文', '报告者无口头/书面描述', '径向突起可能为红外分辨率、眩光或压缩伪影', '精确位置未公开'],
  },

  {
    ...
    figures: [
      { src: '/images/events/army-ir-dual-contrast-2026/01.jpg', caption: 'DVIDS DOW-UAP-PR49 红外静帧：陆军平台双对比区跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006111/DOD_111689168.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/army-ir-dual-contrast-2026/02.png', caption: '美国区位示意——陆军 PR49 相关国家背景（精确事发点未公开）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/USA_orthographic.svg/1280px-USA_orthographic.svg.png', layout: 'pair' },
      { src: '/images/events/army-ir-dual-contrast-2026/03.png', caption: '美国陆军标识——提交机构语境参考（非UAP本体）', credit: 'U.S. Army / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Logo_of_the_United_States_Army.svg/1280px-Logo_of_the_United_States_Army.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689168/DOD_111689168.mp4', caption: 'DoD 直链视频（1分49秒）：DOW-UAP-PR49 陆军红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006111/dow-uap-pr49-unresolved-uap-report-department-army-2026', caption: '官方 DVIDS：DOW-UAP-PR49 未解决UAP报告（Department of the Army, 2026）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'group-sighting', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR49 Army 2026', url: 'https://www.dvidshub.net/video/1006111/dow-uap-pr49-unresolved-uap-report-department-army-2026' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['western-us-autotrack-2020', 'indopacom-ir-uap-2024', 'east-us-rectangular-uap-2019'],
    limitations: ['报告者无口头/书面描述', '表观尺寸变化被官方归因于变焦循环', '未公开地点、距离、高度或平台型号', '双对比区可能对应常规热源或编队航空器'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-orbs-over-pond-2024/01.jpg', caption: 'DVIDS FBI-UAP-PR003 静帧：池塘上空类等离子体光球（隐私裁剪后公开画面）', credit: 'FBI/DoD via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2606/1010267/DOD_111764159.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/fbi-orbs-over-pond-2024/02.png', caption: '美国东北部区位示意——FBI 东北光球集群相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Map_of_the_Northeastern_United_States.png/1280px-Map_of_the_Northeastern_United_States.png', layout: 'pair' },
      { src: '/images/events/fbi-orbs-over-pond-2024/03.png', caption: '联邦调查局印章——认证与调查机构语境参考', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Seal_of_the_Federal_Bureau_of_Investigation.svg/1280px-Seal_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2606/DOD_111764159/DOD_111764159.mp4', caption: 'DoD 直链视频：FBI-UAP-PR003 Orbs Over the Pond（约4分25秒）' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1010267/fbi-uap-pr003-orbs-over-pond-2024', caption: '官方 DVIDS：FBI-UAP-PR003 “Orbs Over the Pond,” 2024' },
    ],
    sensors: ['目视', 'iPhone视频', 'FBI认证'],
    physicalCharacteristics: ['orb', 'plasma-like', 'stationary-hover', 'silent', 'self-luminous', 'group-sighting'],
    sources: [
      { label: 'DVIDS - FBI-UAP-PR003 Orbs Over the Pond', url: 'https://www.dvidshub.net/video/1010267/fbi-uap-pr003-orbs-over-pond-2024' },
      { label: 'Department of War - PURSUE Release 03', url: 'https://www.war.gov/UFO/release/03/' },
    ],
    relatedEvents: ['fbi-triangle-orbs-2021', 'fbi-red-orb-rotation-2022', 'fbi-northeastern-orb-2025', 'eglin-afb-silver-orbs-2024'],
    limitations: ['精确地点为保护隐私未公开', '手持手机拍摄，缺乏测距与多传感器交叉验证', '可能存在大气光学、无人机或未知常规光源解释', '政府认证证人可信度不等于确认物体性质'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-northeastern-orb-2025/01.jpg', caption: 'DVIDS FBI-UAP-PR004 静帧：东北后院红球/双球西移画面', credit: 'FBI/DoD via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2606/1010269/DOD_111764177.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/fbi-northeastern-orb-2025/02.png', caption: '美国东北部区位示意——与池塘光球集群地理关联背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Map_of_the_Northeastern_United_States.png/960px-Map_of_the_Northeastern_United_States.png', layout: 'pair' },
      { src: '/images/events/fbi-northeastern-orb-2025/03.png', caption: '联邦调查局旗帜——PURSUE Release 03 认证机构语境', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Flag_of_the_Federal_Bureau_of_Investigation.svg/960px-Flag_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2606/DOD_111764177/DOD_111764177.mp4', caption: 'DoD 直链视频：FBI-UAP-PR004 Northeastern Orb Sighting（约49秒）' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1010269/fbi-uap-pr004-northeastern-orb-sighting-2025', caption: '官方 DVIDS：FBI-UAP-PR004 “Northeastern Orb Sighting,” 2025' },
    ],
    sensors: ['目视', 'iPhone 14 Pro Max', 'FBI认证'],
    physicalCharacteristics: ['orb', 'plasma-like', 'silent', 'self-luminous', 'group-sighting', 'formation-merge'],
    sources: [
      { label: 'DVIDS - FBI-UAP-PR004 Northeastern Orb Sighting', url: 'https://www.dvidshub.net/video/1010269/fbi-uap-pr004-northeastern-orb-sighting-2025' },
      { label: 'Department of War - PURSUE Release 03', url: 'https://www.war.gov/UFO/release/03/' },
    ],
    relatedEvents: ['fbi-orbs-over-pond-2024', 'fbi-triangle-orbs-2021', 'fbi-red-orb-rotation-2022', 'eglin-afb-silver-orbs-2024'],
    limitations: ['精确地址未公开', '合并过程可能为视线重叠或亮度融合的视错觉', '无雷达或热成像交叉验证', '与东北集群其他案件的物理关联未经独立科学确认'],
  },

  {
    ...
    figures: [
      { src: '/images/events/western-us-autotrack-2020/01.jpg', caption: 'DVIDS DOW-UAP-PR108 红外静帧：美西对比区域与传感器跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014106/DOD_111830058.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/western-us-autotrack-2020/02.png', caption: '美国西部县域空白图——PR108 相关地理背景（精确点位未公开）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Western_United_States_counties%2C_blank.svg/1280px-Western_United_States_counties%2C_blank.svg.png', layout: 'pair' },
      { src: '/images/events/western-us-autotrack-2020/03.jpg', caption: '内利斯空军基地相关训练活动影像——美西军事空域语境参考（非UAP本体）', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Oregon_ANG_pilot_preparing_F-15_flight_at_Nellis_-_Weapons_Instructor_Course.jpg/1280px-Oregon_ANG_pilot_preparing_F-15_flight_at_Nellis_-_Weapons_Instructor_Course.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2607/DOD_111830058/DOD_111830058.mp4', caption: 'DoD 直链视频：DOW-UAP-PR108 美西红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1014106/dow-uap-pr108-unresolved-uap-report-western-united-states-2020', caption: '官方 DVIDS：DOW-UAP-PR108 未解决UAP报告（Western United States, 2020）' },
    ],
    sensors: ['红外', '自动跟踪'],
    physicalCharacteristics: ['auto-track', 'thermal-contrast', 'low-observability', 'multi-sensor'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR108 Western US 2020', url: 'https://www.dvidshub.net/video/1014106/dow-uap-pr108-unresolved-uap-report-western-united-states-2020' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['east-us-rectangular-uap-2019', 'army-ir-dual-contrast-2026', 'gulf-of-america-flicker-2019', 'gov-contractor-metallic-cylinder-2024', 'fbi-blackhawk-thermal-2026', 'fbi-western-red-lights-2026'],
    limitations: ['公开时长与叙述中的时长表述不完全一致', '大量“No content”与模式切换片段', '自动跟踪不等于识别结论', '未公开平台、距离与目标形状'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-triangle-orbs-2021/01.jpg', caption: 'DVIDS FBI-UAP-PR001 静帧：东北部多光源/三角光球集群画面', credit: 'FBI/DoD via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2606/1010263/DOD_111764142.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/fbi-triangle-orbs-2021/02.png', caption: '美国东北部区位示意——FBI 东北光球集群相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Map_of_the_Northeastern_United_States.png/1280px-Map_of_the_Northeastern_United_States.png', layout: 'pair' },
      { src: '/images/events/fbi-triangle-orbs-2021/03.png', caption: '联邦调查局印章——认证与调查机构语境参考', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Seal_of_the_Federal_Bureau_of_Investigation.svg/1280px-Seal_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2606/DOD_111764142/DOD_111764142.mp4', caption: 'DoD 直链视频：FBI-UAP-PR001 Triangle Orbs（约2分42秒）' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1010263/fbi-uap-pr001-triangle-orbs-2021', caption: '官方 DVIDS：FBI-UAP-PR001 “Triangle Orbs,” 2021' },
    ],
    sensors: ['目视', 'iPhone 12 Pro', 'FBI认证'],
    physicalCharacteristics: ['orb', 'group-sighting', 'relative-rotation', 'self-luminous', 'silent', 'bright-white-light'],
    sources: [
      { label: 'DVIDS - FBI-UAP-PR001 Triangle Orbs', url: 'https://www.dvidshub.net/video/1010263/fbi-uap-pr001-triangle-orbs-2021' },
      { label: 'Department of War - PURSUE Release 03', url: 'https://www.war.gov/UFO/release/03/' },
    ],
    relatedEvents: ['fbi-red-orb-rotation-2022', 'fbi-orbs-over-pond-2024', 'fbi-northeastern-orb-2025', 'fbi-isosceles-triangle-2011', 'colorado-springs-translucent-2023'],
    limitations: ['精确地点为保护隐私未公开', '手持手机拍摄，缺乏测距与多传感器交叉验证', '“三角”为公开标题与多光源构型描述，非官方几何鉴定', '政府认证证人可信度不等于确认物体性质'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-red-orb-rotation-2022/01.jpg', caption: 'DVIDS FBI-UAP-PR002 静帧：东北部双红球相对旋转画面', credit: 'FBI/DoD via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2606/1010264/DOD_111764148.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/fbi-red-orb-rotation-2022/02.png', caption: '美国东北部区位示意——与三角光球/池塘光球集群地理关联', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Map_of_the_Northeastern_United_States.png/960px-Map_of_the_Northeastern_United_States.png', layout: 'pair' },
      { src: '/images/events/fbi-red-orb-rotation-2022/03.png', caption: '联邦调查局旗帜——PURSUE Release 03 认证机构语境', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Flag_of_the_Federal_Bureau_of_Investigation.svg/960px-Flag_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2606/DOD_111764148/DOD_111764148.mp4', caption: 'DoD 直链视频：FBI-UAP-PR002 Red Orb Rotation（约2分42秒）' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1010264/fbi-uap-pr002-red-orb-rotation-northeastern-united-states-2022', caption: '官方 DVIDS：FBI-UAP-PR002 “Red Orb Rotation,” 2022' },
    ],
    sensors: ['目视', 'iPhone 12 Pro', 'FBI认证'],
    physicalCharacteristics: ['orb', 'relative-rotation', 'stationary-hover', 'silent', 'self-luminous', 'group-sighting'],
    sources: [
      { label: 'DVIDS - FBI-UAP-PR002 Red Orb Rotation', url: 'https://www.dvidshub.net/video/1010264/fbi-uap-pr002-red-orb-rotation-northeastern-united-states-2022' },
      { label: 'Department of War - PURSUE Release 03', url: 'https://www.war.gov/UFO/release/03/' },
    ],
    relatedEvents: ['fbi-triangle-orbs-2021', 'fbi-orbs-over-pond-2024', 'fbi-northeastern-orb-2025'],
    limitations: ['精确地点未公开', '相对旋转可能为视差、系留灯具或无人机编队造成的表观运动', '无雷达或热成像交叉验证', '与东北集群其他案件的物理关联未经独立科学确认'],
  },

  {
    ...
    figures: [
      { src: '/images/events/greece-circular-ocean-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR35 红外静帧：希腊近海圆形对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006082/DOD_111689022.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/greece-circular-ocean-2023/02.png', caption: '希腊区位示意——PR35 / CENTCOM 希腊近海目击相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/EU-Greece_%28orthographic_projection%29.svg/1280px-EU-Greece_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/greece-circular-ocean-2023/03.png', caption: '地中海区位示意——近海低空飞行语境参考', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Mediterranean_Sea_location_map.svg/1280px-Mediterranean_Sea_location_map.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111689022/DOD_111689022.mp4', caption: 'DoD 直链视频（24秒）：DOW-UAP-PR35 希腊近海红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006082/dow-uap-pr35-unresolved-uap-report-greece-october-2023', caption: '官方 DVIDS：DOW-UAP-PR35 未解决UAP报告（Greece, October 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['orb-spherical', 'thermal-contrast', 'low-observability', 'straight-flight-path', 'transmedium-suspected'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR35 Greece Oct 2023', url: 'https://www.dvidshub.net/video/1006082/dow-uap-pr35-unresolved-uap-report-greece-october-2023' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['greece-ocean-90deg-2023', 'greece-diamond-uap-2024', 'uae-inverted-teardrop-2024'],
    limitations: ['仅24秒视频，目标相对背景对比弱', '转入陆地背景后目标丢失，难以排除海面杂波或小型水面/低空物体', '约30 mph 与“圆形”描述来自任务报告，公开视频难以独立复核', 'unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/uae-ir-track-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR27 红外静帧：阿联酋上空对比区域跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2605/1006067/DOD_111688825.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/uae-ir-track-2023/02.png', caption: '阿联酋区位示意——PR27 目击相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/United_Arab_Emirates_%28orthographic_projection%29.svg/1280px-United_Arab_Emirates_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/uae-ir-track-2023/03.jpg', caption: '阿尔达夫拉空军基地相关活动影像——事件地理语境参考（非UAP本体）', credit: 'U.S. Air National Guard / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Al_Dhafra_Air_Base_gathers_humanitarian_relief_supplies_for_Afghanistan_refugees_210820-Z-BR512-2017.jpg/1280px-Al_Dhafra_Air_Base_gathers_humanitarian_relief_supplies_for_Afghanistan_refugees_210820-Z-BR512-2017.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2605/DOD_111688825/DOD_111688825.mp4', caption: 'DoD 直链视频（4分57秒）：DOW-UAP-PR27 阿联酋红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1006067/dow-uap-pr27-unresolved-uap-report-united-arab-emirates-october-2023', caption: '官方 DVIDS：DOW-UAP-PR27 未解决UAP报告（United Arab Emirates, October 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'low-observability', 'multi-sensor'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR27 UAE Oct 2023', url: 'https://www.dvidshub.net/video/1006067/dow-uap-pr27-unresolved-uap-report-united-arab-emirates-october-2023' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['uae-inverted-teardrop-2024', 'greece-diamond-uap-2024', 'syria-white-light-orb-2024', 'middle-east-ir-track-2023'],
    limitations: ['前约2分钟无内容，有效观测有限', '后期表观剧烈运动被官方归因于传感器/平台运动而非目标机动', '未提供形状、距离、高度或观察者叙述', '对比区域可能对应常规航空器或热源'],
  },

  {
    ...
    figures: [
      { src: '/images/events/gulf-of-america-flicker-2019/01.jpg', caption: 'DVIDS DOW-UAP-PR115 红外静帧：墨西哥湾对比区域跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014123/DOD_111830147.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/gulf-of-america-flicker-2019/02.png', caption: '加勒比海—墨西哥湾地形/水深示意——PR115 相关海域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Caribbean_Sea_Gulf_of_Mexico_shaded_relief_bathymetry_land_map_2.png', layout: 'pair' },
      { src: '/images/events/gulf-of-america-flicker-2019/03.png', caption: '美国区位示意——墨西哥湾相对北美大陆位置', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/USA_orthographic.svg/1280px-USA_orthographic.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2607/DOD_111830147/DOD_111830147.mp4', caption: 'DoD 直链视频（8秒）：DOW-UAP-PR115 墨西哥湾红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1014123/dow-uap-pr115-unresolved-uap-report-gulf-of-america-2019', caption: '官方 DVIDS：DOW-UAP-PR115 未解决UAP报告（Gulf of America, 2019）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR115 Gulf of America 2019', url: 'https://www.dvidshub.net/video/1014123/dow-uap-pr115-unresolved-uap-report-gulf-of-america-2019' },
      { label: 'Department of War - PURSUE Release 04', url: 'https://www.war.gov/UFO/release/04/' },
    ],
    relatedEvents: ['east-us-rectangular-uap-2019', 'western-us-autotrack-2020', 'gimbal-gofast'],
    limitations: ['仅8秒视频，有效跟踪更短', 'AARO明确提示闪烁可能为自动增益效应，不宜解读为目标本体脉冲', '未公开平台、距离、高度或目标形状', '日期在公开目录中仅标为2019年'],
  },

  {
    ...
    figures: [
      { src: '/images/events/gulf-of-oman-cold-orbs-2021/01.jpg', caption: 'DVIDS DOW-UAP-PR117 静帧：AC-130J 红外显示屏二次拍摄中的对比区域', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2608/1017793/DOD_111887401.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/gulf-of-oman-cold-orbs-2021/02.png', caption: '阿曼区位示意——阿曼湾事发海域相邻国家背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Oman_%28orthographic_projection%29.svg/1280px-Oman_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/gulf-of-oman-cold-orbs-2021/03.png', caption: '阿曼湾区位图——PR117 / D101 相关海域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Gulf_of_oman_location_map.svg/1280px-Gulf_of_oman_location_map.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2608/DOD_111887401/DOD_111887401.mp4', caption: 'DoD 直链视频（约16秒）：DOW-UAP-PR117 阿曼湾红外显示二次录像' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1017793/dow-uap-pr117-unresolved-uap-report-gulf-oman-2021', caption: '官方 DVIDS：DOW-UAP-PR117 未解决UAP报告（Gulf of Oman, 2021）' },
    ],
    sensors: ['EO/IR（AC-130J）', '目视（机组）', '手机二次录像', '情报信息报告'],
    physicalCharacteristics: ['cold-orb', 'orb', 'group-sighting', 'high-speed', 'thermal-contrast', 'multi-sensor', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR117 Gulf of Oman 2021', url: 'https://www.dvidshub.net/video/1017793/dow-uap-pr117-unresolved-uap-report-gulf-oman-2021' },
      { label: 'Department of War - PURSUE Release 05 portal', url: 'https://www.war.gov/UFO/' },
      { label: 'Scientific American - Pentagon cold orbs release', url: 'https://www.scientificamerican.com/article/latest-pentagon-ufo-files-release-includes-video-of-mysterious-cold-orbs/' },
    ],
    relatedEvents: ['gulf-of-aden-uap-2024', 'mq-9-yemen-hellfire-2024', 'eglin-afb-silver-orbs-2024', 'uss-jackson-tictac-2023', 'middle-east-ir-track-2023'],
    limitations: ['公开视频为手机拍摄传感器屏幕，非原生主传感器数据', '机上DVR据报失效，完整原生 footage 未公开', '速度与数量估计来自IIR叙述，难以用短二次录像独立复核', '二次录像可能引入模糊/闪烁伪影，unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/tremonton-great-falls-1952/01.jpg', caption: '1956年公开纪录片中的蒙大拿胶片静帧：天空中两处亮点（对应D098分析的1950年胶片；非D098扫描页）', credit: 'Wikimedia Commons / public-domain 1950 film transfer', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Nick_Mariana_UFO_Footage_1950_Great_Falls_Montana.webm', layout: 'full' },
      { src: '/images/events/tremonton-great-falls-1952/02.png', caption: '犹他州在美国区位——D098分析的1952年7月2日胶片拍摄州', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/8/8b/Utah_Locator_Map_with_US.PNG', layout: 'pair' },
      { src: '/images/events/tremonton-great-falls-1952/03.jpg', caption: '犹他州特雷蒙顿附近公路景观——Newhouse胶片相关地理语境（非UAP本体）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/East_on_SR-102_in_Tremonton%2C_Utah%2C_Jun_17.jpg/1280px-East_on_SR-102_in_Tremonton%2C_Utah%2C_Jun_17.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://commons.wikimedia.org/wiki/File:Nick_Mariana_UFO_Footage_1950_Great_Falls_Montana.webm', caption: 'Wikimedia Commons：1950年大瀑布城 Mariana 胶片（含1956年纪录片分析片段）' },
    ],
    sensors: ['16mm彩色胶片', '停帧投影 / 密度计', '海军摄影测量分析'],
    physicalCharacteristics: ['group-sighting', 'self-luminous', 'high-speed', 'multi-sensor'],
    sources: [
      { label: 'Department of War - PURSUE portal (DOW-UAP-D098)', url: 'https://www.war.gov/UFO/' },
      { label: 'AARO / PURSUE catalog description of DOW-UAP-D098', url: 'https://www.aaro.mil/Next-AARO-Home-redesign/Next-Parent/Next-UAP-Report-Documents/' },
      { label: 'UAP Logbook - DOW-UAP-D098 NPIC film analysis', url: 'https://uaplogbook.com/dow-uap-d098-npic-film-analysis/' },
      { label: 'Wikimedia Commons - Mariana 1950 film transfer', url: 'https://commons.wikimedia.org/wiki/File:Nick_Mariana_UFO_Footage_1950_Great_Falls_Montana.webm' },
    ],
    relatedEvents: ['los-alamos-green-fireballs-1949', 'washington-invasion', 'roswell'],
    limitations: ['D098是1953年进度报告，明确不代表海军部官方立场', '报告未给出可靠距离，尺寸与速度估算依赖未知距离假设', 'Robertson小组与Condon研究后来提出鸟类/反光替代解释', '公开胶片拷贝来自1956年纪录片转制，非实验室原始底片'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-isosceles-triangle-2011/01.png', caption: '美国区位示意——D028 精确事发点未公开，仅能给出国家级地理背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/USA_orthographic.svg/1280px-USA_orthographic.svg.png', layout: 'full' },
      { src: '/images/events/fbi-isosceles-triangle-2011/02.png', caption: '联邦调查局印章——FD-302 录入与认证机构语境', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Seal_of_the_Federal_Bureau_of_Investigation.svg/1280px-Seal_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
      { src: '/images/events/fbi-isosceles-triangle-2011/03.png', caption: '美国西部县域空白图——事件可能发生的广阔国内背景（地点未公开）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Western_United_States_counties%2C_blank.svg/1280px-Western_United_States_counties%2C_blank.svg.png', layout: 'pair' },
    ],
    sensors: ['目视（双退役军人）', 'FBI FD-302', '数字再现（非照片）'],
    physicalCharacteristics: ['triangular', 'dark-colored', 'group-sighting', 'low-observability'],
    sources: [
      { label: 'Department of War - PURSUE portal (FBI-UAP-D028/D029)', url: 'https://www.war.gov/UFO/' },
      { label: 'UAP Ledger - PURSUE Release 05 file list', url: 'https://uapledger.com/releases/release-5-2026-08-07' },
      { label: 'UAP Logbook - FBI Triangle Watch 2002–2026', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['fbi-triangle-orbs-2021', 'colorado-springs-translucent-2023', 'fbi-orbs-over-pond-2024'],
    limitations: ['访谈距事发约14年，回忆偏差不可避免', '精确地点未公开', 'D029为艺术性数字再现，不得当作实拍照片', 'FD-302不含FBI鉴定结论，无雷达或热成像交叉验证'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-blackhawk-thermal-2026/01.jpg', caption: '美国陆军 UH-60 黑鹰——D033 中用作热成像尺度与飞行特征参照的已知平台（非UAP本体）', credit: 'U.S. Army / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/US_Army_UH-60_Black_Hawk.jpg/1280px-US_Army_UH-60_Black_Hawk.jpg', layout: 'full' },
      { src: '/images/events/fbi-blackhawk-thermal-2026/02.jpg', caption: '夜视装置操作语境——D033 热光学观察的传感器类别参考', credit: 'U.S. Army / DVIDS via Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/c2/A_CH-47_Chinook_pilot_adjusts_his_night_vision_goggles_DVIDS14813.jpg', layout: 'pair' },
      { src: '/images/events/fbi-blackhawk-thermal-2026/03.png', caption: '联邦调查局旗帜——PURSUE Release 05 FD-302 认证机构语境', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Flag_of_the_Federal_Bureau_of_Investigation.svg/1280px-Flag_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    sensors: ['手持热光学', '目视', '已知军机热参照', 'FBI FD-302'],
    physicalCharacteristics: ['thermal-contrast', 'multi-sensor', 'low-observability', 'silent'],
    sources: [
      { label: 'Department of War - PURSUE portal (FBI-UAP-D033)', url: 'https://www.war.gov/UFO/' },
      { label: 'UAP Ledger - FBI-UAP-D033 Release 05 listing', url: 'https://uapledger.com/releases/release-5-2026-08-07' },
      { label: 'UAP Logbook - FBI Triangle Watch / 2026 thermal case', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['fbi-western-red-lights-2026', 'western-us-autotrack-2020', 'army-ir-dual-contrast-2026'],
    limitations: ['公开材料未附热成像原片或DVIDS视频', '“一半大小”是代理人基于并排热对比的估计，非测距结果', '精确坐标未公开', 'FD-302不含FBI对目标身份的结论'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-western-red-lights-2026/01.jpg', caption: '美西空域中的陆军直升机——D037/D040 山脊线夜间观察的作战/空域语境参考（非UAP本体）', credit: 'U.S. Army / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/United_States_Army_Black_Hawk_Helicopter_%2853575794990%29.jpg/1280px-United_States_Army_Black_Hawk_Helicopter_%2853575794990%29.jpg', layout: 'full' },
      { src: '/images/events/fbi-western-red-lights-2026/02.jpg', caption: '美国西部荒漠景观——D037/D040 未公开精确点位的地域类型参考', credit: 'BLM / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Utah_Dunes_Landscape_-_West_Desert_District.jpg/1280px-Utah_Dunes_Landscape_-_West_Desert_District.jpg', layout: 'pair' },
      { src: '/images/events/fbi-western-red-lights-2026/03.png', caption: '联邦调查局印章——Release 05 FD-302 与数字再现的认证机构语境', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Seal_of_the_Federal_Bureau_of_Investigation.svg/1280px-Seal_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'pair' },
    ],
    sensors: ['目视', '夜视装置（NOD）', '机械手表对照', 'FBI FD-302'],
    physicalCharacteristics: ['self-luminous', 'group-sighting', 'electromagnetic', 'orb'],
    sources: [
      { label: 'Department of War - PURSUE portal (FBI-UAP-D037/D040)', url: 'https://www.war.gov/UFO/' },
      { label: 'UAP Ledger - FBI-UAP-D037/D040 Release 05 listings', url: 'https://uapledger.com/releases/release-5-2026-08-07' },
      { label: 'UAP Logbook - FBI Triangle Watch 2002–2026', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['fbi-blackhawk-thermal-2026', 'fbi-red-orb-rotation-2022', 'western-us-autotrack-2020'],
    limitations: ['精确地点与日期在公开目录中仅标为2026年西部', 'D038/D039/D041/D042为艺术再现，不是照片', '机械手表快25分钟可能是故障或操作误差，不能直接等同电磁效应', 'FD-302不含FBI结论，无雷达交叉验证'],
  },

  {
    ...
    figures: [
      { src: '/images/events/colorado-springs-translucent-2023/01.jpg', caption: '从派克峰俯瞰科罗拉多斯普林斯——D026 事发城市地理语境', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Colorado_Springs_from_Pikes_Peak.jpg/1280px-Colorado_Springs_from_Pikes_Peak.jpg', layout: 'full' },
      { src: '/images/events/colorado-springs-translucent-2023/02.png', caption: '科罗拉多州地理图——D026 相关州级背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Colorado_geographic_map-en.svg/1280px-Colorado_geographic_map-en.svg.png', layout: 'pair' },
      { src: '/images/events/colorado-springs-translucent-2023/03.png', caption: '科罗拉多州在美国区位——Release 05 三角集群中的落基山前缘城市', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/63/Colorado_Locator_Map_with_US.PNG', layout: 'pair' },
    ],
    sensors: ['目视（双证人）', 'FBI FD-302', '数字再现（非照片）'],
    physicalCharacteristics: ['triangular', 'low-observability', 'silent', 'group-sighting'],
    sources: [
      { label: 'Department of War - PURSUE portal (FBI-UAP-D026/D027)', url: 'https://www.war.gov/UFO/' },
      { label: 'Official War.gov catalog text via Probed (FBI-UAP-D026)', url: 'https://probed.space/ufo-files/files/fbi-uap-d026-fd-302-dark-translucent-triangle-2023' },
      { label: 'UAP Logbook - FBI Triangle Watch 2002–2026', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['fbi-isosceles-triangle-2011', 'fbi-triangle-orbs-2021', 'eglin-afb-silver-orbs-2024'],
    limitations: ['无照片或视频，D027仅为艺术再现', '观察仅约4秒，缺乏测距与多传感器数据', '“水下畸变”可能是大气光学或回忆修辞', '与同城D030红灯三角案无官方合并结论'],
  },

  {
    ...
    figures: [
      { src: '/images/events/middle-east-ir-track-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR149 红外静帧：中东海域/空域对比区域跟踪画面（含红色瞄准框）', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2608/1017799/DOD_111887426.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/middle-east-ir-track-2023/02.png', caption: '中东区位示意——PR149 / CENTCOM 责任区地理背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Middle_East_%28orthographic_projection%29.svg/1280px-Middle_East_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/middle-east-ir-track-2023/03.jpg', caption: 'CENTCOM责任区内美军战斗机巡逻——中东传感器作战语境参考（非UAP本体）', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/A_U.S._Air_Force_F-16_Fighting_Falcon_assigned_to_the_77th_Expeditionary_Fighter_Squadron%2C_flies_a_combat_patrol_mission_within_the_U.S._Central_Command_area_of_responsibility%2C_Feb._13%2C_2023.jpg/1280px-thumbnail.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2608/DOD_111887426/DOD_111887426.mp4', caption: 'DoD 直链视频（51秒）：DOW-UAP-PR149 中东红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1017799/dow-uap-pr149-unresolved-uap-report-middle-east-2023', caption: '官方 DVIDS：DOW-UAP-PR149 未解决UAP报告（Middle East, 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'low-observability', 'straight-flight-path'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR149 Middle East 2023', url: 'https://www.dvidshub.net/video/1017799/dow-uap-pr149-unresolved-uap-report-middle-east-2023' },
      { label: 'Department of War - Fifth PURSUE Release statement', url: 'https://www.war.gov/News/Releases/Release/Article/4565994/department-of-war-publishes-fifth-release-of-unidentified-anomalous-phenomena-f/' },
      { label: 'Department of War - UFO / PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['uae-ir-track-2023', 'gulf-of-oman-cold-orbs-2021', 'syria-white-light-orb-2024', 'greece-circular-ocean-2023'],
    limitations: ['无观察者叙述或量化运动学参数', '51秒跟踪可能对应常规船舶、航空器或海面热源', '精确位置与平台未公开', 'unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/fbi-slow-moving-objects-2026/01.jpg', caption: 'DVIDS FBI-UAP-PR007 静帧：西部手持热成像中的慢速黑热对比区域', credit: 'FBI/DoD via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2608/1017801/DOD_111887430.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/fbi-slow-moving-objects-2026/02.png', caption: '美国西部公共土地示意——PR007 相关地域背景（精确地点未公开）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/2/2b/Public-Lands-Western-US-ar.png', layout: 'pair' },
      { src: '/images/events/fbi-slow-moving-objects-2026/03.jpg', caption: '联邦调查局总部——PURSUE Release 05 认证与调查机构语境', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/FBI_Headquarters.jpg/1280px-FBI_Headquarters.jpg', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2608/DOD_111887430/DOD_111887430.mp4', caption: 'DoD 直链视频（约10秒）：FBI-UAP-PR007 Slow-moving Objects' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1017801/fbi-uap-pr007-slow-moving-objects-2026', caption: '官方 DVIDS：FBI-UAP-PR007 “Slow-moving Objects,” 2026' },
    ],
    sensors: ['手持热成像', '射频探测告警', '目视', 'FD-302'],
    physicalCharacteristics: ['thermal-contrast', 'group-sighting', 'electromagnetic', 'low-observability', 'dark-colored'],
    sources: [
      { label: 'DVIDS - FBI-UAP-PR007 Slow-moving Objects', url: 'https://www.dvidshub.net/video/1017801/fbi-uap-pr007-slow-moving-objects-2026' },
      { label: 'Department of War - Fifth PURSUE Release Statement, August 7, 2026', url: 'https://www.war.gov/News/Releases/Release/Article/4565994/department-of-war-publishes-fifth-release-of-unidentified-anomalous-phenomena-f/' },
      { label: 'CBS News - Pentagon fifth UFO files release', url: 'https://www.cbsnews.com/news/ufo-files-pentagon-5th-release-documents-videos/' },
      { label: 'Department of War - PURSUE portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['western-us-autotrack-2020', 'fbi-orbs-over-pond-2024', 'eglin-afb-silver-orbs-2024', 'colorado-springs-triangle-2023'],
    limitations: ['公开视频仅约10秒，完整5–10分钟观察未公开', '精确地点与平台未公开', '射频告警与热成像目标的物理对应未经独立复核', 'FD-302 不含 FBI 结论，unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/middle-east-eoir-2025/01.jpg', caption: 'DVIDS DOW-UAP-PR134 静帧：中东 EO/IR 对比区域跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2608/1017792/DOD_111887390.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/middle-east-eoir-2025/02.png', caption: '中东区位示意——PR134 / CENTCOM 相关战区背景（精确位置未公开）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Middle_East_%28orthographic_projection%29.svg/1280px-Middle_East_%28orthographic_projection%29.svg.png', layout: 'pair' },
      { src: '/images/events/middle-east-eoir-2025/03.png', caption: '美国中央司令部印章——提交机构语境参考', credit: 'U.S. Department of Defense / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Seal_of_the_United_States_Central_Command.png/960px-Seal_of_the_United_States_Central_Command.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2608/DOD_111887390/DOD_111887390.mp4', caption: 'DoD 直链视频（1分39秒）：DOW-UAP-PR134 中东光电/红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1017792/dow-uap-pr134-unresolved-uap-report-middle-east-2025', caption: '官方 DVIDS：DOW-UAP-PR134 未解决UAP报告（Middle East, 2025）' },
    ],
    sensors: ['光电', '红外'],
    physicalCharacteristics: ['thermal-contrast', 'multi-sensor', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR134 Middle East 2025', url: 'https://www.dvidshub.net/video/1017792/dow-uap-pr134-unresolved-uap-report-middle-east-2025' },
      { label: 'Department of War - PURSUE Release 05 portal', url: 'https://www.war.gov/UFO/' },
      { label: 'Department of War - Fifth PURSUE Release Statement, August 7, 2026', url: 'https://www.war.gov/News/Releases/Release/Article/4565994/department-of-war-publishes-fifth-release-of-unidentified-anomalous-phenomena-f/' },
    ],
    relatedEvents: ['middle-east-reticle-2023', 'middle-east-dual-contrast-2023', 'gulf-of-oman-cold-orbs-2021', 'syria-white-light-orb-2024'],
    limitations: ['未公开平台、坐标、距离与目标形状', '无观察者叙述，难以排除常规航空器或热源', '模式/倍率切换会造成表观运动，不等于目标机动', 'unresolved 不代表确认异常'],
  },

  {
    ...
    figures: [
      { src: '/images/events/middle-east-reticle-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR136 静帧：中东红外对比区域（含十字线/平台遮挡时段画面）', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2608/1017796/DOD_111887413.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/middle-east-reticle-2023/02.png', caption: '阿拉伯半岛区位示意——CENTCOM 中东传感器集群相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Arabian_Peninsula_%28orthographic_projection%29.png/1280px-Arabian_Peninsula_%28orthographic_projection%29.png', layout: 'pair' },
      { src: '/images/events/middle-east-reticle-2023/03.png', caption: '伊拉克—叙利亚区位示意——中东战区地理语境参考（非事发坐标）', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Iraq_Syria_Locator_%28orthographic_projection%29.svg/1280px-Iraq_Syria_Locator_%28orthographic_projection%29.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2608/DOD_111887413/DOD_111887413.mp4', caption: 'DoD 直链视频（约33秒）：DOW-UAP-PR136 中东红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1017796/dow-uap-pr136-unresolved-uap-report-middle-east-2023', caption: '官方 DVIDS：DOW-UAP-PR136 未解决UAP报告（Middle East, 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'auto-track', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR136 Middle East 2023', url: 'https://www.dvidshub.net/video/1017796/dow-uap-pr136-unresolved-uap-report-middle-east-2023' },
      { label: 'Department of War - PURSUE Release 05 portal', url: 'https://www.war.gov/UFO/' },
    ],
    relatedEvents: ['middle-east-eoir-2025', 'middle-east-dual-contrast-2023', 'western-us-autotrack-2020', 'greece-ocean-90deg-2023'],
    limitations: ['有效跟踪约半分钟，且被平台构件多次遮挡', '十字线锁定不等于识别或测距结论', '未公开平台、坐标与观察者叙述', '对比区域可能对应常规热源或航空器'],
  },

  {
    ...
    figures: [
      { src: '/images/events/middle-east-dual-contrast-2023/01.jpg', caption: 'DVIDS DOW-UAP-PR024 静帧：中东红外双亮对比区 / 暗对比区跟踪画面', credit: 'DoD/AARO via DVIDS', sourceUrl: 'https://d1ldvf68ux039x.cloudfront.net/thumbs/frames/video/2607/1014100/DOD_111830020.0000001/1000w_q95.jpg', layout: 'full' },
      { src: '/images/events/middle-east-dual-contrast-2023/02.jpg', caption: '波斯湾卫星影像——CENTCOM 中东任务相关海域背景（非事发坐标）', credit: 'NASA / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/QeshmIsland_NASA.jpg/1280px-QeshmIsland_NASA.jpg', layout: 'pair' },
      { src: '/images/events/middle-east-dual-contrast-2023/03.png', caption: '叙利亚区位示意——中东战区地理语境参考', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Syria_%28orthographic_projection%29.svg/1280px-Syria_%28orthographic_projection%29.svg.png', layout: 'pair' },
    ],
    media: [
      { type: 'video', url: 'https://d34w7g4gy10iej.cloudfront.net/video/2607/DOD_111830020/DOD_111830020.mp4', caption: 'DoD 直链视频（18秒）：DOW-UAP-PR024 中东红外 footage' },
      { type: 'video', url: 'https://www.dvidshub.net/video/1014100/dow-uap-pr024-unresolved-uap-report-middle-east-2023', caption: '官方 DVIDS：DOW-UAP-PR024 未解决UAP报告（Middle East, 2023）' },
    ],
    sensors: ['红外'],
    physicalCharacteristics: ['thermal-contrast', 'group-sighting', 'auto-track', 'low-observability'],
    sources: [
      { label: 'DVIDS - DOW-UAP-PR024 Middle East 2023', url: 'https://www.dvidshub.net/video/1014100/dow-uap-pr024-unresolved-uap-report-middle-east-2023' },
      { label: 'Department of War - PURSUE Release 04', url: 'https://www.war.gov/UFO/release/04/' },
    ],
    relatedEvents: ['middle-east-reticle-2023', 'middle-east-eoir-2025', 'syria-white-light-orb-2024', 'army-ir-dual-contrast-2026'],
    limitations: ['仅18秒视频，亮对比区过境约3秒', '未公开平台、坐标与观察者叙述', '双亮对比区可能为编队航空器、曳光弹或其他热源', '结尾闪白由传感器设置切换造成，不宜解读为目标闪光'],
  },

  {
    ...
    figures: [
      { src: '/images/events/bagram-triangle-2002/01.jpg', caption: 'FBI-UAP-D025 数字复原图：按2002年巴格拉姆飞行员描述绘制的等边三角形（艺术性辅助，非现场照片）', credit: 'FBI via PURSUE Release 05 (public domain reproduction)', sourceUrl: 'https://www.war.gov/UFO/', layout: 'full' },
      { src: '/images/events/bagram-triangle-2002/02.jpg', caption: '巴格拉姆空军基地鸟瞰——2002年6月目击相关地点背景', credit: 'U.S. Air Force / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Aerial_view_of_Bagram_Air_Base.jpg/1280px-Aerial_view_of_Bagram_Air_Base.jpg', layout: 'pair' },
      { src: '/images/events/bagram-triangle-2002/03.png', caption: '阿富汗区位示意——巴格拉姆相关地域背景', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Afghanistan_%28orthographic_projection%29.svg/1280px-Afghanistan_%28orthographic_projection%29.svg.png', layout: 'pair' },
    ],
    sensors: ['目视（两名飞行员）', 'FD-302'],
    physicalCharacteristics: ['triangular', 'silent', 'group-sighting', 'dark-colored', 'low-observability', 'straight-flight-path'],
    sources: [
      { label: 'Department of War - PURSUE Release 05 portal', url: 'https://www.war.gov/UFO/' },
      { label: 'CBS News - Pentagon fifth UFO files release (Bagram triangle)', url: 'https://www.cbsnews.com/news/ufo-files-pentagon-5th-release-documents-videos/' },
      { label: 'UAP Logbook - FBI Triangle Watch 2002–2026', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['colorado-springs-triangle-2023', 'belgium-ufo-wave', 'washington-invasion', 'rendelsham-forest'],
    limitations: ['目击与FD-302间隔约22年，存在回忆偏差', 'D025为FBI事后数字复原，不是传感器或照片证据', '尺度与150节为目击者估计，无雷达交叉验证公开', 'FD-302 不含 FBI 结论'],
  },

  {
    ...
    figures: [
      { src: '/images/events/colorado-springs-triangle-2023/01.png', caption: '联邦调查局印章——D030/D031 认证与调查机构语境（本案无公开现场照片）', credit: 'FBI / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Seal_of_the_Federal_Bureau_of_Investigation.svg/1024px-Seal_of_the_Federal_Bureau_of_Investigation.svg.png', layout: 'full' },
      { src: '/images/events/colorado-springs-triangle-2023/02.jpg', caption: '派克峰——科罗拉多斯普林斯夜空目击相关地貌背景', credit: 'David Shankbone / Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Pikes_Peak_by_David_Shankbone.jpg/1280px-Pikes_Peak_by_David_Shankbone.jpg', layout: 'pair' },
      { src: '/images/events/colorado-springs-triangle-2023/03.jpg', caption: '众神花园暮色——科罗拉多斯普林斯城市与山脊线语境参考', credit: 'Wikimedia Commons', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Garden_of_the_Gods_Sunset.jpg/960px-Garden_of_the_Gods_Sunset.jpg', layout: 'pair' },
    ],
    sensors: ['目视（两名目击者）', '手机通话（电磁干扰叙述）', 'FD-302'],
    physicalCharacteristics: ['triangular', 'instantaneous-acceleration', 'ninety-degree-turns', 'electromagnetic', 'dark-colored', 'group-sighting'],
    sources: [
      { label: 'Department of War - PURSUE Release 05 portal', url: 'https://www.war.gov/UFO/' },
      { label: 'CBS News - Pentagon fifth UFO files release', url: 'https://www.cbsnews.com/news/ufo-files-pentagon-5th-release-documents-videos/' },
      { label: 'UAP Logbook - FBI Triangle Watch 2002–2026', url: 'https://uaplogbook.com/fbi-triangle-watch-2002-2026/' },
    ],
    relatedEvents: ['bagram-triangle-2002', 'belgium-ufo-wave', 'fbi-slow-moving-objects-2026', 'pantex-intrusion-2015'],
    limitations: ['无公开传感器视频或雷达轨迹', '马赫数、厚度与90度机动为目击者估计', 'D031为FBI事后数字复原，不是现场影像', '与同月同城 D026 透明三角案的关联未经官方确认', 'FD-302 不含 FBI 结论'],
  },
