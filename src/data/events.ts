...
export const events: UAPEvent[] = [
  ...
  },
  {
    ...
    figures: [
      { src: '/images/events/roswell/01.jpg', caption: '罗斯威尔事件——事件封面影像', credit: 'UAP Explorer archive', layout: 'full' },
      { src: '/images/events/roswell/02.jpg', caption: 'Jesse Marcel少校在1947年7月9日的新闻发布会上展示被官方解释为气象气球的残骸材料', credit: 'ufoevidence.org', sourceUrl: 'http://ufoevidence.org/cases/pictures/JesseMarcelSr1.jpg', layout: 'pair' },
...

  {
    ...
    figures: [
      { src: '/images/events/gulf-of-aden-uap-2024/01.jpg', caption: '亚丁湾UAP高速目击事件——事件封面影像', credit: 'UAP Explorer archive', layout: 'full' },
      { src: '/images/events/gulf-of-aden-uap-2024/02.jpg', caption: 'DOW-UAP-D75 官方任务报告封面：2024年7月14日美军ISR平台在亚丁湾记录UAP事件的MISREP文档，由第124攻击中队提交至USCENTCOM/AARO', credit: 'uapdisclosurefiles.com', sourceUrl: 'https://uapdisclosurefiles.com/data/files/thumb/dow-uap-d75-mission-report-gulf-of-aden-july-2024.jpg', layout: 'pair' },
      { src: '/images/events/gulf-of-aden-uap-2024/03.webp', caption: 'USA Today报道：2024年10月30日也门沿海，MQ-9 Reaper锁定不明球体，AGM-114 Hellfire导弹即将接触目标前的红外画面（来源：U.S. military via Congress）', credit: 'gannett-cdn.com', sourceUrl: 'https://www.gannett-cdn.com/authoring/authoring-images/2025/09/10/USAT/86074279007-missile.jpg?crop=1919,1079,x0,y0', layout: 'pair' },
      { src: '/images/events/gulf-of-aden-uap-2024/04.webp', caption: 'Yahoo News/USA Today：MQ-9 Reaper在亚丁湾/也门海岸跟踪高速飞行球体，导弹击中后物体继续飞行轨迹，未受明显损伤', credit: 's.yimg.com', sourceUrl: 'https://s.yimg.com/ny/api/res/1.2/qX3_rvdi.xoqAOGlL2LP2g--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTU0MDtjZj13ZWJw/https://media.zenfs.com/en/usa_today_news_641/ad58e5b22fdf46e7a94b834de8f731d5', layout: 'inset' },
    ],
    media: [
...

  {
    ...
    figures: [
      { src: '/images/events/sts-80-columbia-1996/01.jpg', caption: 'STS-80航天飞机轨道不明物照片——事件封面影像', credit: 'UAP Explorer archive', layout: 'full' },
      { src: '/images/events/sts-80-columbia-1996/02.jpg', caption: 'STS-80 任务：航天飞机哥伦比亚号运抵 39B 发射台（1996年10月16日，NASA / 公有领域）', credit: 'upload.wikimedia.org', sourceUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/4a/STS-80_Roll_Out_01.jpg', layout: 'pair' },
      { src: '/images/events/sts-80-columbia-1996/03.jpg', caption: 'PURSUE Release 04 官方门户 — STS-80 三张 NASA 不明物原图（NASA-UAP-D030/D031/D032）可在此查看与下载', credit: 'war.gov', sourceUrl: 'https://www.war.gov/UFO/release/04/', layout: 'pair' },
    ],
