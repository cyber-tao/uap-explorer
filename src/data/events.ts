...
limitations: ['物体从未被拦截或回收', '物理性质仍为未解之谜'],
  ...
  },
  {
    ...
    media: [
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Gimbal_The_First_Official_UAP_Footage_from_the_USG_for_Public_Release.webm/1280px--Gimbal_The_First_Official_UAP_Footage_from_the_USG_for_Public_Release.webm.jpg', caption: 'Gimbal官方静帧——2015年罗斯福号东海岸（USG public release / Wikimedia）' },
      { type: 'image', url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Go_Fast_Official_USG_Footage_of_UAP_for_Public_Release.webm/1280px--Go_Fast_Official_USG_Footage_of_UAP_for_Public_Release.webm.jpg', caption: 'GoFast官方静帧——海上高速UAP（USG public release / Wikimedia）' },
