...
│   │   ├── EventCard.tsx         # 国际化事件卡片
│   │   ├── EventEditorialBody.tsx# 杂志化图文排版
│   │   ├── ImageLightbox.tsx     # 影像全屏灯箱
│   │   ├── TimelineFilters.tsx   # 筛选栏
│   │   ├── ErrorBoundary.tsx     # 路由错误边界
...
│   │   ├── LanguageContext.tsx   # Provider 组件
│   │   ├── index.ts              # Barrel 导出
