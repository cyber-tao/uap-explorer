...
const FALLBACKS: Record<string, Array<{ url: string; caption: string; credit: string }>> = {
  ...
  'uae-inverted-teardrop-2024': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/United_Arab_Emirates_%28orthographic_projection%29.svg/1280px-United_Arab_Emirates_%28orthographic_projection%29.svg.png',
  ...
  'syria-white-light-orb-2024': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Syria_%28orthographic_projection%29.svg/1280px-Syria_%28orthographic_projection%29.svg.png',
  ...
  'uss-jackson-tictac-2023': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/USS_Jackson_%28LCS-6%29_underway_in_the_Philippine_Sea_on_18_October_2021_%28211018-N-PL200-0005%29.JPG/1280px-USS_Jackson_%28LCS-6%29_underway_in_the_Philippine_Sea_on_18_October_2021_%28211018-N-PL200-0005%29.JPG',
      caption: 'USS Jackson（LCS-6）在航——跨介质 Tic Tac 遭遇相关载具',
      credit: 'U.S. Navy / Wikimedia Commons',
    },
  ],
  'langley-afb-drone-swarm-2023': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/2_U.S._Air_Force_F-22_Raptors_fly_over_Joint_Base_Langley-Eustis%2C_Virginia%2C_June_12%2C_2018.jpg/1280px-2_U.S._Air_Force_F-22_Raptors_fly_over_Joint_Base_Langley-Eustis%2C_Virginia%2C_June_12%2C_2018.jpg',
      caption: 'F-22 飞越兰利-尤斯蒂斯联合基地——无人机群入侵相关基地',
      credit: 'U.S. Air Force / Wikimedia Commons',
    },
  ],
  'indopacom-ir-uap-2024': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg/1280px-Indo-Pacific_map_outlines_with_ASEAN_overlay.jpg',
      caption: '印太区域轮廓示意——PR48 作战区语境',
      credit: 'Wikimedia Commons',
    },
  ],
  'africa-uap-2025': [
    {
      url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Africa_%28orthographic_projection%29.svg/1280px-Africa_%28orthographic_projection%29.svg.png',
